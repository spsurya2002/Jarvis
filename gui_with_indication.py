...
def process_command():
    ...
    if "time" in query:
        ...
        indication.set("Function: Play Music")
        ...
        os.system("spotify")
        indication.set("Function: Open Spotify")
    else:
...
if __name__ == '__main__':
    ...
    indication.set("Function: ")

    indication_label = Label(root, textvariable=indication)
